...
internal sealed partial class AdbWebSocketHandler
{
    private static (string Command, CommandType CommandType) GetMappedCommand(string? command)
    {
        ...
        return command switch
        {
            ...
            _ when command.Equals(AdbTvRemoteCommands.MuteToggle, StringComparison.OrdinalIgnoreCase) => (AdbTvConstants.Mute, CommandType.KeyEvent),
            ...
            _ when command.Equals(AdbTvRemoteCommands.CursorUp, StringComparison.OrdinalIgnoreCase) => (AdbTvConstants.DpadUp, CommandType.KeyEvent),
            ...
            _ when command.Equals(AdbTvRemoteCommands.CursorDown, StringComparison.OrdinalIgnoreCase) => (AdbTvConstants.DpadDown, CommandType.KeyEvent),
            ...
            _ when command.Equals(AdbTvRemoteCommands.CursorLeft, StringComparison.OrdinalIgnoreCase) => (AdbTvConstants.DpadLeft, CommandType.KeyEvent),
            ...
            _ when command.Equals(AdbTvRemoteCommands.CursorRight, StringComparison.OrdinalIgnoreCase) => (AdbTvConstants.DpadRight, CommandType.KeyEvent),
            ...
            _ when command.Equals(AdbTvRemoteCommands.CursorEnter, StringComparison.OrdinalIgnoreCase) => (AdbTvConstants.DpadCenter, CommandType.KeyEvent),
